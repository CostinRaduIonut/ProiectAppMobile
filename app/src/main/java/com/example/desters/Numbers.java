...
public class Numbers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView = findViewById(R.id.text_inserted4);
        ...
        Intent serviceIntent = new Intent(Numbers.this, MyService.class);
        startService(serviceIntent);

        scorNumbers = getIntent().getIntExtra("scor", 0);
        View view = null;
        onClickNextN(view);
    }
    ...
    public void onClickX(View v) {
        ...
        intent.putExtra("result", scorNumbers);
        setResult(RESULT_OK, intent);
        finish();
    }

    public void onClickCluesN(View view) {
    ...
    public void verificaN(View view) {
        mySharedPrefEditor.putString("myAns", textView.getText().toString());
        mySharedPrefEditor.commit();

        if (textView.getText().toString().equals(raspunsCorect)) {
            scorNumbers = scorNumbers + 1;
            Toast.makeText(getApplicationContext(), "Good job", Toast.LENGTH_SHORT).show();

        }
    }

    public void onClickNextN(View view) {
        mySharedPrefEditor.putString("myAns", textView.getText().toString());
        mySharedPrefEditor.commit();
        if (id < 3) {
            id = id + 1;
            System.out.println(id);
            setGhicitoareN(view, String.valueOf(id));
    ...
    public void onClickPrevN(View view) {
        mySharedPrefEditor.putString("myAns", textView.getText().toString());
        mySharedPrefEditor.commit();
        if (id > 0) {
            System.out.println(id);
    ...
    public void setGhicitoareN(View view, String idDeTrimis) {
        ...
        ((okhttp3.Call) call).enqueue(new Callback() {
            ...
            public void onResponse(@NonNull okhttp3.Call call, @NonNull okhttp3.Response response) throws IOException {
                ...
                JSONObject obj;
                TextView ghicitoare = findViewById(R.id.ghicitoare4);
                try {
